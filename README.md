...
This project uses the [Sleep Health and Lifestyle Dataset](sleep_health_lifestyle_dataset.xlsx), which contains information on sleep duration, quality, stress levels, physical activity, and other lifestyle factors.
